...
public class CreateRem_ALL_BTMU_India {
    ...
    Date date = new Date();
	//java.lang.String amount = (dateFormat.format(date));
    String amount = Integer.toString((int)(10 + (int)(Math.random() * 100000))); 
	...
	
	{
		...
		try{
			...
			System.setProperty("weblogin1.ie.driver", file.getAbsolutePath());
			...
			driver.findElement(By.name("password")).sendKeys("tcs123");
...
//1.)  Create REM LVP Unitary
			...
			amount = Integer.toString((int)(10 + (int)(Math.random() * 100000)));
...
//2.)  Create REM RTGS Unitary
			...
			amount = Integer.toString((int)(10 + (int)(Math.random() * 100000)));
			driver.findElement(By.id("ct_ct_Beneficiary_wca_AMT")).findElement(By.tagName("input")).sendKeys("100"+amount);
			//System.out.println("Amount entered");
			driver.findElement(By.id("Save&Close50")).click();	
			//System.out.println("Save and close");		
...
//3.)  Create REM LVP FL level
			...
			driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("000015");
			//System.out.println("debit account entered");
...
//4.)  Create REM LVP IPL level
			...
			driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("380954");
			//System.out.println("debit account entered");
			driver.findElement(By.name("ct_ct_Payments_wca_REMIT_TYPE")).click();
...
//5.)  Create REM RTGS File level
			...
			driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("500011");
			//System.out.println("debit account entered");
			driver.findElement(By.name("ct_ct_Payments_wca_REMIT_TYPE")).click();
			driver.findElement(By.id("selectCombo_ct_ct_Payments_wca_SPLIT_MTHD_Text")).sendKeys("File Level");
			...
			driver.findElement(By.name("ct_ct_Beneficiary_wca_CR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("123456");
			amount = Integer.toString((int)(10 + (int)(Math.random() * 100000)));
			driver.findElement(By.id("ct_ct_Beneficiary_wca_AMT")).findElement(By.tagName("input")).sendKeys("78"+amount);
			//System.out.println("1st Amount entered");
			//Click on save button
	        driver.findElement(By.id("butName_38")).click();		
	        ...
	        driver.findElement(By.name("ct_ct_Beneficiary_wca_CR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("123456");
	        amount = Integer.toString((int)(10 + (int)(Math.random() * 100000)));
	        driver.findElement(By.id("ct_ct_Beneficiary_wca_AMT")).findElement(By.tagName("input")).sendKeys("89"+amount);
			//System.out.println("2nd Amount entered");
			//Click on save button
	        driver.findElement(By.id("butName_38")).click();
	        Thread.sleep(3000);
...
//06.) Create and auth IP Level RTGS
			...
			driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("500018");
			//System.out.println("debit account entered");
			driver.findElement(By.name("ct_ct_Payments_wca_REMIT_TYPE")).click();
			driver.findElement(By.id("selectCombo_ct_ct_Payments_wca_SPLIT_MTHD_Text")).sendKeys("Individual Payment Level");
			Thread.sleep(1000);
			...
			driver.findElement(By.name("ct_ct_Beneficiary_wca_CR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("123456");
			amount = Integer.toString((int)(10 + (int)(Math.random() * 100000)));
			driver.findElement(By.id("ct_ct_Beneficiary_wca_AMT")).findElement(By.tagName("input")).sendKeys("103"+amount);
			//System.out.println("1st Amount entered");
			//Click on save button
	        driver.findElement(By.id("butName_38")).click();		
	        ...
	        driver.findElement(By.name("ct_ct_Beneficiary_wca_CR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("123456");
	        amount = Integer.toString((int)(10 + (int)(Math.random() * 100000)));
	        driver.findElement(By.id("ct_ct_Beneficiary_wca_AMT")).findElement(By.tagName("input")).sendKeys("105"+amount);
			//System.out.println("2nd Amount entered");
			//Click on save button
	        driver.findElement(By.id("butName_38")).click();
	        Thread.sleep(3000);
...
//7.) Create and auth Book Transfer
			...
			driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).findElement(By.tagName("input")).sendKeys("500022");
			//System.out.println("debit account entered");
...
//9.) Create and auth File Level Book_Transfer_IB
			...
			//System.out.println("debit account entered");
			driver.findElement(By.name("ct_ct_Payments_wca_REMIT_TYPE")).click();
			WebElement clrng = driver.findElement(By.id("selectCombo_ct_ct_Payments_wca_SPLIT_MTHD_Text"));
			System.out.println("element found");
			clrng.sendKeys("File Level");
			//driver.findElement(By.id("selectCombo_ct_ct_Payments_wca_SPLIT_MTHD_Text")).sendKeys("File Level");
			//driver.findElement(By.id("selectCombo_ct_ct_Payments_wca_SPLIT_MTHD_Txt")).sendKeys("File Level");
			amount = Integer.toString((int)(10 + (int)(Math.random() * 100000)));
			driver.findElement(By.id("ct_ct_Beneficiary_wca_AMT")).findElement(By.tagName("input")).sendKeys(amount);
...
//12.) Create and auth IP Level BT
			...
			WebElement abc =driver.findElement(By.id("selectCombo_ct_ct_BeneficiaryDiscription_wca_CLR_TYP_Text"));
			System.out.println("BT selected");
			abc.sendKeys("BookTransfer");
			System.out.println("BT selected");
			//driver.findElement(By.id("selectCombo_ct_ct_BeneficiaryDiscription_wca_CLR_TYP_Text")).sendKeys("BookTransfer");
			//System.out.println("BT selected");
