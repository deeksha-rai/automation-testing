...
//1.)  Create REM LVP Unitary
			...
			System.out.println("1.) *************************REM LVP Unitary************************ " + RemId1);
			remitance1.accept();
...
//2.)  Create REM HVP Unitary
			...
			System.out.println("2.) *************************REM HVP Unitary************************ " + RemId2);
			remitance2.accept();
...
//3.)  Create REM Interbranch Unitary
			...
			System.out.println("3.) *************************REM Interbranch Unitary************************ " + RemId3);
			remitance2.accept();
		
//8.)  Create REM LVP Unitary Forex Ben
			driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).sendKeys("3640VNDDTC900168");
			System.out.println("debit account entered");
				...
				System.out.println("drop down for currency button clicked");
							driver.findElement(By.xpath("/html/body/form/ul[2]/li/ul/li/fieldset/ul/li[14]/div/div/ul/li[4]")).click();
				System.out.println("USD clicked");
			driver.findElement(By.id("ct_ct_Beneficiary_wca_CR_ACNT_IDNTFR")).sendKeys("12345");
			
			driver.findElement(By.id("ct_ct_BeneficiaryBankDetail_wca_BEN_BNK_IDNTFR_TYP_1-button")).click();
			System.out.println("drop down for selecting ebank selected");
			Thread.sleep(2000);
			
			driver.findElement(By.xpath("/html/body/form/ul[2]/li/ul[3]/li/div/div[5]/fieldset/ul/li/div/div/ul/li[2]")).click();
			System.out.println("Ebank selected");
			
			
			driver.findElement(By.id("ct_ct_BeneficiaryBankDetail_wca_BEN_BNK_IDNTFR_ID_1")).sendKeys("80202001");
			System.out.println("BIC given ");
			
			driver.findElement(By.id("ct_ct_BeneficiaryBankDetail_wca_BN_BK_ADRS_LN1")).sendKeys("sdsfsdf");
			...
			System.out.println("1.) *************************REM LVP Unitary Forex Ben************************ " + RemId8);
			remitance101.accept();
			
			
//9.)  Create REM LVP Unitary Forex Our Equivalent
			driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).sendKeys("3640VNDDTC900168");
			System.out.println("debit account entered");
				driver.findElement(By.id("ct_ct_Payments_wca_forex_typ-button")).click();
				
				System.out.println("drop down for forex type clicked");
							driver.findElement(By.xpath("/html/body/form/ul[2]/li/ul/li/fieldset/ul/li[13]/div/div/ul/li[2]")).click();
				System.out.println("Equivalent clicked");
				driver.findElement(By.id("ct_ct_Payments_wca_CRNCY-button")).click();
				
				System.out.println("drop down for currency button clicked");
							driver.findElement(By.xpath("/html/body/form/ul[2]/li/ul/li/fieldset/ul/li[14]/div/div/ul/li[2]")).click();
				System.out.println("VND clicked");
driver.findElement(By.id("ct_ct_Payments_wca_ORGNL_INSTRCTD_CRNCY-button")).click();
				
				System.out.println("drop down for instructed currency button clicked");
							driver.findElement(By.xpath("/html/body/form/ul[2]/li/ul/li/fieldset/ul/li[10]/div/div/ul/li[4]")).click();
				System.out.println("JPY clicked");
			...
			driver.findElement(By.id("ct_ct_Beneficiary_wca_AMT")).sendKeys("35"+amount);
			System.out.println("Amount entered");
			Alert save103 = driver.switchTo().alert();
			save103.accept();
			
			driver.findElement(By.id("Save&Close55")).click();	
			System.out.println("Save and close");	
			
			Alert save102 = driver.switchTo().alert();
			save102.accept();
			
			Thread.sleep(2000);
			Alert remitance102 = driver.switchTo().alert();
			
			S=remitance102.getText();
			
			 RemId9 = S.substring(S.indexOf("-") + 2);
			System.out.println("1.) *************************REM LVP Unitary Forex Ben************************ " + RemId9);
			remitance102.accept();
			
//10.)  Create REM Forex FCY EUR
			
			
			
			driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).sendKeys("3640EURDTC074802");
			System.out.println("debit account entered");
				driver.findElement(By.id("ct_ct_Payments_wca_forex_typ-button")).click();
			...
			Alert save105 = driver.switchTo().alert();
			save105.accept();
			
			Thread.sleep(2000);
			Alert remitance105 = driver.switchTo().alert();
			
			S=remitance105.getText();
			
			 RemId10 = S.substring(S.indexOf("-") + 2);
			System.out.println("1.) *************************REM LVP Unitary Forex Ben************************ " + RemId10);
			remitance105.accept();
...
//4.)  Create REM HVP MDMC level
			...
			System.out.println("4.) ************************REM HVP MDMC level:************************ " + RemId4);
			remitance3a.accept();
			Thread.sleep(3000);
	        driver.findElement(By.id("Save&Close55")).click();	
			//System.out.println("Save and close");
...
//5.)  Create REM HVP MDMC level
		...
		System.out.println("5.) ************************REM HVP MDMC level order master id************************ " + RemId5);
		remitance3a.accept();
		Thread.sleep(3000);
        driver.findElement(By.id("Save&Close55")).click();	
		//System.out.println("Save and close");
...
//6.) Create and auth Book Transfer
		...
		System.out.println("6.) ************************Book Transfer Rem id************************ " + RemId6);
		remitance7.accept();	
...
S = new String();
		...
		driver.findElement(By.id("ct_ct_Payments_wca_DR_ACNT_IDNTFR")).sendKeys("3640VNDORD041858");
		driver.findElement(By.id("ct_ct_Payments_wca_REMIT_TYPE")).click();
		...
		driver.findElement(By.id("ct_ct_Beneficiary_wca_CR_ACNT_IDNTFR")).sendKeys("3640VNDORD041734");
		driver.findElement(By.id("ct_ct_Beneficiary_wca_AMT")).sendKeys(amount);
		//System.out.println("Amount entered");
		Thread.sleep(2000);		
...
Thread.sleep(1000);
        driver.findElement(By.id("ct_ct_Beneficiary_wca_CR_ACNT_IDNTFR")).sendKeys("3640VNDORD041777");
		...
		System.out.println("7.) ************************Book Transfer File Level Order id************************ " + RemId7);
		remitance3a.accept();
		Thread.sleep(3000);
        driver.findElement(By.id("Save&Close55")).click();	
		System.out.println("Save and close");
