...
public class Auth_Rem_india {
	...
	
	{
		...
		dr.findElement(By.id("propertyMap(MCB_SearchWC_wca_TXN_POS_NUM_RNGVAL_From)")).sendKeys("114101");
        Thread.sleep(2000);
	...
	//public void Auth_Order(WebDriver dr)
		{
			...
			{
				Thread.sleep(2000);
				dr.findElement(By.id("propertyMap(MCB_SearchWC_wca_MBRSEQNO_RNGVAL_From)")).clear();
