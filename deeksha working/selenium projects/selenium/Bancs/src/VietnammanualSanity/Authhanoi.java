...
import VietnammanualSanity.Createhanoi;

public class Authhanoi {
	
public WebDriver SologIn() throws InterruptedException
	
	{
		...
		driver.findElement(By.name("userId")).sendKeys("sanity2");
...
public void Authso(WebDriver dr,String remId,int i)
...

{
	...
	{	
	 ...
	 dr.findElement(By.id("propertyMap(MCB_SearchWC_wca_TXN_POS_NUM_CASL_From)")).sendKeys(remId);
    Thread.sleep(2000);
