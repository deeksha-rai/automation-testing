...
public class Bt_sendback_cancel {
	...
	public void ORcancel(WebDriver wd)
	//public void authCTBT(WebDriver wd)
	{
		try{
			Thread.sleep(5000);
	...
	//	WebDriverWait wait4 = new WebDriverWait(wd, 20);
		...
		//System.out.println("value sent to text box");
		WebDriverWait wait5 = new WebDriverWait(wd, 20);
		wait5.until(ExpectedConditions.elementToBeClickable(By.id("butName_14"))).click();
		System.out.println("Release is performed");	
		//WebDriverWait wait6 = new WebDriverWait(wd, 20);

		 Alert save = wd.switchTo().alert();
		save.accept();
		wd.close();
		System.out.println("OR Repaired");	
		}
	...
	public static void main(String args[]) throws InterruptedException{
		...
		Bt_sendback_cancel CBT =new Bt_sendback_cancel();
