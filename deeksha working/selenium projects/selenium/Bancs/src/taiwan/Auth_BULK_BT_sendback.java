...
public class Auth_BULK_BT_sendback {
	...
	//sendback operation
		...
		//	wait5.until(ExpectedConditions.elementToBeClickable(By.xpath(""))).click();
			//wait7.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/div[6]/div[3]/div[2]/table/tbody/tr/td/td[2]/input"))).click();
